...
public class SalaController {
    ...
    public SalaDTO update(@Valid @RequestBody SalaDTO salaDTO, @RequestParam("serie") Integer serie, @RequestParam("letra") String letra){
        return this.salaService.update(salaDTO, serie, letra);
    }

    @PostMapping("/sala/delete/{serie}/{letra}")
    public SalaDTO delete(@RequestParam("serie") Integer serie, @RequestParam("letra") String letra){
        return this.salaService.delete(serie, letra);
    }

    @GetMapping("/sala/{serie}/{letra}")
    public SalaDTO getSala(@RequestParam("serie") Integer serie, @RequestParam("letra") String letra){
